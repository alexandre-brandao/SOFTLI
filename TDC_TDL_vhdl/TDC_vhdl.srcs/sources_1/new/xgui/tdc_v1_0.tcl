...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SIMULATED_TAP_DELAY_PS" -parent ${Page_0}
...
proc update_PARAM_VALUE.SIMULATED_TAP_DELAY_PS { PARAM_VALUE.SIMULATED_TAP_DELAY_PS } {
	# Procedure called to update SIMULATED_TAP_DELAY_PS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SIMULATED_TAP_DELAY_PS { PARAM_VALUE.SIMULATED_TAP_DELAY_PS } {
	# Procedure called to validate SIMULATED_TAP_DELAY_PS
	return true
}
...
proc update_MODELPARAM_VALUE.SIMULATED_TAP_DELAY_PS { MODELPARAM_VALUE.SIMULATED_TAP_DELAY_PS PARAM_VALUE.SIMULATED_TAP_DELAY_PS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.SIMULATED_TAP_DELAY_PS}] ${MODELPARAM_VALUE.SIMULATED_TAP_DELAY_PS}
}
