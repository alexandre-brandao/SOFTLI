...
/******************************************************************/
/* Definitions for driver SINGLESHOT */
#define XPAR_SINGLESHOT_NUM_INSTANCES 1

/* Definitions for peripheral SINGLESHOT_0 */
#define XPAR_SINGLESHOT_0_DEVICE_ID 0
#define XPAR_SINGLESHOT_0_S00_AXI_BASEADDR 0x43C00000
#define XPAR_SINGLESHOT_0_S00_AXI_HIGHADDR 0x43C00FFF
...
/* Definitions for peripheral BRAM_CONTROLLER */
#define XPAR_BRAM_CONTROLLER_DEVICE_ID 0U
#define XPAR_BRAM_CONTROLLER_DATA_WIDTH 32U
#define XPAR_BRAM_CONTROLLER_ECC 0U
#define XPAR_BRAM_CONTROLLER_FAULT_INJECT 0U
#define XPAR_BRAM_CONTROLLER_CE_FAILING_REGISTERS 0U
#define XPAR_BRAM_CONTROLLER_UE_FAILING_REGISTERS 0U
#define XPAR_BRAM_CONTROLLER_ECC_STATUS_REGISTERS 0U
#define XPAR_BRAM_CONTROLLER_CE_COUNTER_WIDTH 0U
#define XPAR_BRAM_CONTROLLER_ECC_ONOFF_REGISTER 0U
#define XPAR_BRAM_CONTROLLER_ECC_ONOFF_RESET_VALUE 0U
#define XPAR_BRAM_CONTROLLER_WRITE_ACCESS 0U
#define XPAR_BRAM_CONTROLLER_S_AXI_BASEADDR 0x40000000U
#define XPAR_BRAM_CONTROLLER_S_AXI_HIGHADDR 0x40001FFFU
#define XPAR_BRAM_CONTROLLER_S_AXI_CTRL_BASEADDR 0xFFFFFFFFU 
#define XPAR_BRAM_CONTROLLER_S_AXI_CTRL_HIGHADDR 0xFFFFFFFFU 


/* Definitions for peripheral BRAM_CTRL_MEASURE */
#define XPAR_BRAM_CTRL_MEASURE_DEVICE_ID 1U
#define XPAR_BRAM_CTRL_MEASURE_DATA_WIDTH 32U
#define XPAR_BRAM_CTRL_MEASURE_ECC 0U
#define XPAR_BRAM_CTRL_MEASURE_FAULT_INJECT 0U
#define XPAR_BRAM_CTRL_MEASURE_CE_FAILING_REGISTERS 0U
#define XPAR_BRAM_CTRL_MEASURE_UE_FAILING_REGISTERS 0U
#define XPAR_BRAM_CTRL_MEASURE_ECC_STATUS_REGISTERS 0U
#define XPAR_BRAM_CTRL_MEASURE_CE_COUNTER_WIDTH 0U
#define XPAR_BRAM_CTRL_MEASURE_ECC_ONOFF_REGISTER 0U
#define XPAR_BRAM_CTRL_MEASURE_ECC_ONOFF_RESET_VALUE 0U
#define XPAR_BRAM_CTRL_MEASURE_WRITE_ACCESS 0U
#define XPAR_BRAM_CTRL_MEASURE_S_AXI_BASEADDR 0x42000000U
#define XPAR_BRAM_CTRL_MEASURE_S_AXI_HIGHADDR 0x42001FFFU
#define XPAR_BRAM_CTRL_MEASURE_S_AXI_CTRL_BASEADDR 0xFFFFFFFFU 
#define XPAR_BRAM_CTRL_MEASURE_S_AXI_CTRL_HIGHADDR 0xFFFFFFFFU 


/******************************************************************/

/* Canonical definitions for peripheral BRAM_CONTROLLER */
#define XPAR_BRAM_0_DEVICE_ID XPAR_BRAM_CONTROLLER_DEVICE_ID
...
/* Canonical definitions for peripheral BRAM_CTRL_MEASURE */
#define XPAR_BRAM_1_DEVICE_ID XPAR_BRAM_CTRL_MEASURE_DEVICE_ID
